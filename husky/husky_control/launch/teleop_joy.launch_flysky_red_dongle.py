...
def generate_launch_description():
    ...
    #)
    filepath_config_joy = PathJoinSubstitution([FindPackageShare('husky_control'), 'config/teleop_flysky_red_dongle.yaml'])
    #filepath_config_joy = PathJoinSubstitution([FindPackageShare('husky_control'), 'config/teleop_logitech.yaml'])
