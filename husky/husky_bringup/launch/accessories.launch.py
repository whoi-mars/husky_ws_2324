...
def generate_launch_description():
    ...
    primary_lidar_3d_enable = EnvironmentVariable('CPR_3D_LASER', default_value='true')  #Initially, it was false
    primary_lidar_3d_model = EnvironmentVariable('CPR_3D_LASER_MODEL', default_value='vlp16')
    primary_lidar_3d_ip = EnvironmentVariable('CPR_3D_LASER_HOST', default_value='192.168.131.21')  #Initially, it was 192.168.131.20
    primary_lidar_3d_topic = EnvironmentVariable('CPR_3D_LASER_TOPIC', default_value='velodyne_points') #Initially, it was mid/points
    primary_lidar_3d_mount = EnvironmentVariable('CPR_3D_LASER_MOUNT', default_value='velodyne') #Initially, it was mid_velodyne
    ...
    if (primary_lidar_3d_enable.perform(lc)) == 'true':
        if (primary_lidar_3d_model.perform(lc) == 'vlp16'):
            ...
            #     "VLP16db.yaml"],
            # )
            config_velodyne_driver_vlp16 = '/opt/ros/foxy/share/velodyne_driver/config/VLP16-velodyne_driver_node-params.yaml'
            config_velodyne_pointcloud_vlp16 = '/opt/ros/foxy/share/velodyne_pointcloud/config/VLP16-velodyne_convert_node-params.yaml'
            config_velodyne_pointcloud_vlp16_calibration = '/opt/ros/foxy/share/velodyne_pointcloud/params/VLP16db.yaml'

            print("Path is: ",config_velodyne_pointcloud_vlp16 )
    ...
    primary_imu_port = EnvironmentVariable('CPR_IMU_PORT', default_value='/dev/ttyACM0')
