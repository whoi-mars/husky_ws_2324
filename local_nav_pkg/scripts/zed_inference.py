...
path2config ='/home/administrator/TensorFlow/penguin_detection_model/exported_models/eff_det_0_22/pipeline.config'
path2model = '/home/administrator/TensorFlow/penguin_detection_model/exported_models/eff_det_0_22/checkpoint'
...
class PenguinInferenceNode(Node):
    ...
    def __init__(self):
        ...
        self.subscriber = self.create_subscription(ImageMessage, '/zed2/zed_node/left/image_rect_color', self.image_callback, 1)
