...
class BasicNavigator(Node):
    def __init__(self):
        ...
        # amcl_pose_qos not used for our application
        ...
        # We are not using nav_through_poses_client but using nav_to_pose_client
    ...
    def waitUntilNav2Active(self):
        # self._waitForInitialPose() #Not required because we are not using AMCL
...
def main(argv=sys.argv[1:]):
    ...
    goal_pose.pose.position.x = argv[0] #These arguments are being passed from gps_goal_calculations.py
    goal_pose.pose.position.y = argv[1]
